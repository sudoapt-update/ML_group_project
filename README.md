...
data/
  raw/                imdb_raw.csv, tweeteval_raw.csv, manifest.json
  processed/          imdb_{train,val,test}.csv, tweet_final_test.csv,
                      tweet_unlabelled_pool.csv, README.md
logs/                 collect.log, clean.log
```

## Reproduce
```
python3 -m venv .venv
.venv/bin/pip install datasets pandas emoji scikit-learn pyarrow
